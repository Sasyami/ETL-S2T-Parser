...
| `source_columns` | колонки источников: тип, PK, not-null и описание; специализированный лист дополняется сырым S2T |
| `target_columns` | целевые колонки: тип, PK, not-null и описание; специализированный лист дополняется сырым S2T |
