...
> **Актуальное состояние live-сценариев:** [46 сценариев: 7 основных и 39 остальных](LIVE_AGENT_STATUS_REPORT_2026-09-03.md). Отчёт находится в корне репозитория и содержит текущую семантическую оценку и причины оставшихся провалов.
