...
- `scripts/run_multiagent_experiments.py`, `scripts/run_multiagent_holdout.py`, `scripts/gigachat_budget.py` — E1–E5 matrix, preregistered Max-only multiagent A/B и fail-closed token guard для Ultra.
